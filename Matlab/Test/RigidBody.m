% https://in.mathworks.com/help/robotics/ug/build-basic-rigid-body-tree-models.html

%The rigid body tree robot model represents the entire robot, 
% which is made up of rigid bodies and joints that attach them together. 
% The base of the robot is a fixed frame that defines the world coordinates.
